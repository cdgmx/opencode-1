...
console.table(
  summaries.map((summary) => ({
    ...
    tracked_max_total_rss_mb: summary.tracked_max_total_rss_mb,
    host_max_memory_used_percent: summary.host_max_memory_used_percent,
    host_max_swap_used_mb: summary.host_max_swap_used_mb,
    host_max_load_avg_1m: summary.host_max_load_avg_1m,
